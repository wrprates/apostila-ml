...
- *Churn* voluntário (clientes que cancelam assinatura).
- *Turnover* voluntário (funcionários que pedem demissão).
- Inconsistências em cobranças de planos de saúde.
- Gestão de estoques.
- Logística (redução de falhas em entregas).
- Manutenção de aeronaves, entre outros.
...
- [Site pessoal](https://cienciaenegocios.com/)
- [CV Lattes](http://lattes.cnpq.br/5885808985726209)
- [Gitlab](https://gitlab.com/wrprates)
- [Github](https://github.com/wrprates/)

# Setup para acompanhar

Você irá encontrar o repositório desta apostila [neste link no Github](https://github.com/wrprates/apostila-ml).
