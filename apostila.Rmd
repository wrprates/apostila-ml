---
title: 'Apostila prática de *Machine Learning* para negócios'
---
...
*Machine Learning*, ou Aprendizado de Máquina, é uma área muito ampla e bastante complexa. Contudo, é também um campo com infinitas possibildades de uso. Nos negócios não é diferente, é possível aplicar *machine learning* de diversas maneiras. 

A ideia desta apostila é **trazer os conceitos básicos para alguns dos principais modelos de aprendizado de máquina e na sequência mostrar como implementá-los**. Não é propósito deste material entrar a fundo nos detalhes de cada modelo, pois a proposta deste material é focar na compreensão dos conceitos e dos casos de usos.
...
Wlademir Ribeiro Prates atualmente é Gerente na Ernst & Young (EY), atuando com ciência de dados na equipe de People Analytics na área de People Advisory Services. Trabalha com projetos em grandes empresas voltados a RH. Entre os temas dos projetos estão: análise de turnover, performance, inconsistências em cobranças de planos de saúde, entre outros.
...
# Setup para acompanhar

Os scripts com os códigos que rodam cada exemplo nesta apostila são escritos na linguagem R. Para rodar os códigos em R utiliza-se o software [RStudio](https://rstudio.com/). 

Há uma versão do RStudio, que é o [RStudio Cloud](https://rstudio.cloud/), que é uma ótima opção para estudar R. Isto porque o RStudio Cloud fornece uma infraestrutura online com pré-configurações que fazem com que a maioria dos pacotes funcionem sem problemas.

<!-- https://rstudio.cloud/project/43760 -->
